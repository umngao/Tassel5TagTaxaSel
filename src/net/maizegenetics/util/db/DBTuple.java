...
import static net.maizegenetics.util.db.TransformerService.convert;
...
public interface DBTuple extends Collection<Pair<String, ? extends Object>> {
    ...
    public default DBTuple subTuple(final String... subset) {
    ...
    public default DBTuple merge(DBTuple second) {
    ...
    public default DBTuple set(Pair<String, ?> ... columns) {
        DefaultDBTuple newTuple = new DefaultDBTuple(columns);
        return newTuple.merge(this);
    }


    public  default DBTuple reduce(String suffix) {
